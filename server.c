...
void checkvote(int client_sock)
{
	...
	FILE *fp;
	char buff[255];
	fp = fopen("/home/somraj/cnproject/Voters_List.txt", "r");
	int voter_found = 0;
	...
	memset(client_message,'\0',sizeof(client_message));
		...
		fp = fopen("/home/somraj/cnproject/Votes.txt", "r");
		...
		if (vote_casted == 0)
		{
			...
			fp = fopen("/home/somraj/cnproject/Candidates_List.txt", "r");
			...
			fp = fopen("/home/somraj/cnproject/Votes.txt", "a");
			fputs(vote, fp);
			fclose(fp);
	...
	else
	{
		...
		FILE *fp;
		char buff[255];
		fp = fopen("/home/somraj/cnproject/Voters_List.txt", "a");
